...
public class LightControlMixerBehaviour : PlayableBehaviour
{
    ...
    private float m_DefaultInnerSpotAngle;
    private float m_DefaultSpotAngle;
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        if (!m_FirstFrameHappened)
        {
            ...
            m_DefaultInnerSpotAngle = m_TrackBinding.innerSpotAngle;
            m_DefaultSpotAngle = m_TrackBinding.spotAngle;
        ...
        float blendedInnerSpotAngle = 0f;
        float blendedSpotAngle = 0f;
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            blendedInnerSpotAngle += input.innerSpotAngle * inputWeight;
            blendedSpotAngle += input.spotAngle * inputWeight;
        ...
        m_TrackBinding.innerSpotAngle = blendedInnerSpotAngle + m_DefaultInnerSpotAngle * (1f - totalWeight);
        m_TrackBinding.spotAngle = blendedSpotAngle + m_DefaultSpotAngle * (1f - totalWeight);
    }
    ...
    public override void OnPlayableDestroy (Playable playable)
    {
        ...
        m_TrackBinding.innerSpotAngle = m_DefaultInnerSpotAngle;
        m_TrackBinding.spotAngle = m_DefaultSpotAngle;
    }
}
